...
class LibraryReportDiscLibrary extends Model
{
    ...
    public function getSuccessSpec()
    {
        return (
    ...
    public function showLibraryReportWithData($year, $speciality, $discipline, $compiler, $createdate)
    {
        //$string = "the_long_string";
        //$array = str_split($string, 4); //$array will contain elements which each is 1000 chars long.
    ...
    public function updateStatusInLibraryReportDisc($update) {
        $LR = DB::table('MY_LR_DISC')
            ->select(['ACTIVITY'])
