    ...
    <div class="row">
                                ...
                                <td class="col-md-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="alert-info">
                                            <a class="dropdown-item btn btn-outline-info" href="{{ route('LibraryReportDiscLibraryCompiled.showLibraryReport') }}?year={{ $value->yeared }}&speciality={{ $value->speciality }}&discipline={{ $value->discipline }}&compiler={{ Session::get('Authenticate.name') }}&createdate={{ $value->createdate }}"><i class="fa fa-eye"></i> Открыть</a>
                                        </div>
                                        @if (($value->status) == 8)
        ...
        @else
            <div class="col-md-12 alert alert-info text-center">
                ...
                <button href="javascript:void(0)" data-toggle="modal"
                        data-target="#ModalCreateLibraryReportFormCenter"
                        class="col-md-12 btn btn-outline-info btn-lg text-white text-center">Нажмите чтобы создать новую библиографическую справку
                </button>
                </p>
            </div>
        @endif
