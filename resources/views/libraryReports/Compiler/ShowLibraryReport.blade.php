                                    ...
                                    @if(($LibraryReport['Status'] == 8))
                                        <div class="alert-warning">
                                            <a class="dropdown-item btn-outline-warning"
                                               href="{{ route('Compiler.editLibraryReport',['year' => $LibraryReport['Yeared'], 'specialitycode' =>$LibraryReport['SpecialityCode'], 'disciplinecode' => $LibraryReport['DisciplineCode']])}}" >
