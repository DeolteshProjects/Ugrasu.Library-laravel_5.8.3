...
@section('content')
    <div class="col-lg-12">
        <h3 class="text-center card-title">Новые составленные библиографические справки</h3>
        ...
        <div class="card">
            <div class="card-body">
                @if(count($data) == 0)
                    <h3>
                    <div class="alert alert-warning text-center">На данный момент новые библиографические справки отсутствуют</div>
                    </h3>
                    @else
                <h4 class="card-title">Новые составленные библиографические справки</h4>
                <h6 class="card-subtitle">Отображены справки имеющие статус <span
                            class="label label-light-warning">Новые</span></h6>
                @if((count($data)>10))
