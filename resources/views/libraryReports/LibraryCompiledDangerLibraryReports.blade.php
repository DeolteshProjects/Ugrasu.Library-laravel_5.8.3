...
@section('content')
    <div class="col-lg-12">
        <h3 class="text-center card-title">Отклоненные составленные библиографические справки</h3>
        ...
        <div class="card">
            <div class="card-body">
                @if(count($data) == 0)
                    <h3>
                    <div class="alert alert-warning text-center">На данный момент отклоненные библиографические справки отсутствуют</div>
                    </h3>
                    @else
                <h4 class="card-title">Отклоненные библиографические справки</h4>
                <h6 class="card-subtitle">Отображены справки имеющие статус <span
                            class="label label-light-danger">Отклонена библиотекой</span></h6>
                @if((count($data)>10))
                ...
                <table id="demo-foo-pagination" class="table m-b-0 toggle-arrow-tiny" data-page-size="">
                    ...
                    @foreach($data as $value)
                        <tr class="row">
                            ...
                            <!-- Статус -->
                            <td class="col-md-1 text-center"><span class="label label-light-danger"><b>Отклонена библиотекой</b> </span></td>
                            <!-- Составитель -->
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <div class="alert-primary">
                                            @if (($value->status) == 10)
                                                <button class="dropdown-item btn-outline-primary"><i class="fa fa-file-word-o"></i> Печать</button>
                                            @endif
                                        </div>
                                    </div>
                                </div>
